...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView = findViewById<View>(R.id.recyclerviewId) as RecyclerView
        recyclerView.layoutManager = LinearLayoutManager(this)
        recyclerView.adapter = adapter

        findViewById<View>(R.id.button_update_country).setOnClickListener {updateLetterCountry()}
    }
    ...
    override fun onClick(view: View) {
        ...
        Toast.makeText(this, "The country selected : ${country}", Toast.LENGTH_SHORT).show()
    }

    fun updateLetterCountry(){
        ...
        for((index,country) in countries.withIndex()){
            if(lastLetter.isUpperCase()){
                ...
                countries[index]=country.toUpperCase().capitalize()
            }
        }
